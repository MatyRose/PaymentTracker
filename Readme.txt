...
-add- add currency with amounth. Example:USD 100
...
-------------------------------------------------------------
Download & unzip or clone https://github.com/MatyRose/PaymentTracker . Open PaymentTracker-master directory. You will see classes directory, src directory, file.txt and Readme.txt. Open command line at this directory. Type:javac -d classes -cp classes src/paymenttracker/*.java
